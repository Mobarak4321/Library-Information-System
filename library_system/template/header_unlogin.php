...
if(!isset($_SESSION)){
  ...
  if(isset($_POST['login'])){
      ...
      $sql = "SELECT * FROM users_list WHERE username='$username' and userpassword='$userpassword'";
      ...
      if($total > 0){
          ...
          echo header("Location: ../pages/books.php");
      } else {
...
<nav class="navbar navbar-expand-lg navbar-dark bg-primary">
  <a class="navbar-brand" href="">CKCST LIBRARY MANAGEMENT SYSTEM</a>
  ...
  <div class="collapse navbar-collapse" id="navbarColor02">
    ...
    <form class="form-inline my-2 my-lg-0" method="post">
      ...
      <input class="form-control mr-sm-2" placeholder="Password" type="password" name="userpassword">
